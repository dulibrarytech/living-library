...
function get_completed_donation(url) {
    fetch(url)
        ...
        .then(data => {
            ...
            let html = '<h2>Person making donation</h2>';
            ...
            if (who_to_notify === null) {
                html += '<h2>No person to be notified of donation.</h2>'
            } else {
            ...
            html += '<p><span class="label">Title: </span>' + recipient.title
                    + '</p>';
            html += '<p><span class="label">First Name: </span>'
            ...
            if (book === null) {
                html += '<h2>No book information.</h2>'
            } else {
